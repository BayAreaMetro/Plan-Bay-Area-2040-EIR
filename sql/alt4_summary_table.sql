...
create view UrbanSim.Counties_TPAs_Alt_4_Overlay_DataSummary as 
SELECT 
COUNTYNAME, 
Summary_Class, 
...
FROM 
	(SELECT  CountyName,
		...
		FROM UrbanSim.Counties_TPAs_Alt_4_Overlay_DataSummary t
		Group By t.CountyName) t
JOIN 
	(   select CountyName,
		Cast(Sum(Acres) as numeric(18,0)) as In_TPAs
		From UrbanSim.Counties_TPAs_Alt_4_Overlay_DataSummary 
