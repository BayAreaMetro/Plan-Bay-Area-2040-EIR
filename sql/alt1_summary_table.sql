create view UrbanSim.Counties_TPAs_Alt_1_Overlay_DataSummary as 
SELECT 
COUNTYNAME, 
Summary_Class, 
...
FROM 
	(SELECT  CountyName,
		...
		FROM UrbanSim.Counties_TPAs_Alt_1_Overlay_DataSummary t
		Group By t.CountyName) t
JOIN 
	(   select CountyName,
		Cast(Sum(Acres) as numeric(18,0)) as Total_Acres_Class_3 
		From UrbanSim.Counties_TPAs_Alt_1_Overlay_DataSummary 
