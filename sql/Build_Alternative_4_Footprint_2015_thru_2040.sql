...
SELECT Analysis.p09_01_2015_parcel_shareable.COUNTY_ID as county_id, 
Analysis.run17_parcel_output.parcel_id as parcel_id, 
cast(Analysis.run17_parcel_output.year_built as integer) asyear_built,
cast(Analysis.run17_parcel_output.job_spaces as integer) asjob_spaces,
cast(Analysis.run17_parcel_output.total_residential_units as integer) astotal_residential_units,
Analysis.p09_01_2015_parcel_shareable.Shape as Shape
FROM Analysis.run17_parcel_output
left join Analysis.p09_01_2015_parcel_shareable
on Analysis.p09_01_2015_parcel_shareable.parcel_id = Analysis.run17_parcel_output.parcel_id
...
SELECT Analysis.p09_01_2015_parcel_shareable.COUNTY_ID as county_id, 
Analysis.run11_parcel_output.parcel_id as parcel_id, 
cast(Analysis.run11_parcel_output.year_built as integer) as year_built,
cast(Analysis.run11_parcel_output.job_spaces as integer) as job_spaces,
cast(Analysis.run11_parcel_output.total_residential_units as integer) as total_residential_units,
Analysis.p09_01_2015_parcel_shareable.Shape as Shape
FROM Analysis.run11_parcel_output
left join Analysis.p09_01_2015_parcel_shareable
on Analysis.p09_01_2015_parcel_shareable.parcel_id = Analysis.run11_parcel_output.parcel_id
WHERE cast(Analysis.run11_parcel_output.year_built as integer)>2015;

GO 

CREATE VIEW Analysis.run12_parcel_output_spatial AS
SELECT Analysis.p09_01_2015_parcel_shareable.COUNTY_ID as county_id, 
Analysis.run12_parcel_output.parcel_id as parcel_id, 
cast(Analysis.run12_parcel_output.year_built as integer) asyear_built,
cast(Analysis.run12_parcel_output.job_spaces as integer) asjob_spaces,
cast(Analysis.run12_parcel_output.total_residential_units as integer) astotal_residential_units,
Analysis.p09_01_2015_parcel_shareable.Shape as Shape
FROM Analysis.run12_parcel_output
left join Analysis.p09_01_2015_parcel_shareable
on Analysis.p09_01_2015_parcel_shareable.parcel_id = Analysis.run12_parcel_output.parcel_id
WHERE cast(Analysis.run12_parcel_output.year_built as integer)>2015;

GO 

CREATE VIEW Analysis.run7224_parcel_output_spatial AS
SELECT Analysis.p09_01_2015_parcel_shareable.COUNTY_ID as county_id, 
Analysis.run7224_parcel_output.parcel_id as parcel_id, 
cast(Analysis.run7224_parcel_output.year_built as integer) asyear_built,
cast(Analysis.run7224_parcel_output.job_spaces as integer) asjob_spaces,
cast(Analysis.run7224_parcel_output.total_residential_units as integer) astotal_residential_units,
Analysis.p09_01_2015_parcel_shareable.Shape as Shape
FROM Analysis.run7224_parcel_output
left join Analysis.p09_01_2015_parcel_shareable
on Analysis.p09_01_2015_parcel_shareable.parcel_id = Analysis.run7224_parcel_output.parcel_id
WHERE cast(Analysis.run7224_parcel_output.year_built as integer)>2015;
